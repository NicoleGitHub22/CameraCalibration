...
Client::Client(QObject *parent, int screenShift, std::string clientID) : QObject(parent)
{
    ...
    imagePath = "home/bretznic/Documents/GitHub/CameraCalibration/SphericalHarmonics/";
    imagePathCal = "home/bretznic/Documents/GitHub/CameraCalibration/Calibration/Camera_calibration/Pattern_Images/";
