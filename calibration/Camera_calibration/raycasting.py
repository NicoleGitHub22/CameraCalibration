...
def load_extrinsics(monitor_id):
    rotation_filename = f"../Calculations/Matrices_Monitors/matrices_monitor{monitor_id}.txt"
    translation_filename = f"../Calculations/Translation_Results/translation_result{monitor_id}.txt"
...
def map_displayed_to_captured(displayed_image_filename):
    ...
    captured_image_path = f"../Lightstage/Build/Server/{captured_image_filename}"
